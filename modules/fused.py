...
class ConvBnReLU(FakeQuantize):
    def __init__(self,
        ...
        super().__init__(observer_w_name, quantizer_w_name,\
             observer_a_name, quantizer_a_name, w_symmetric, a_symmetric)
...
class ConvBn(ConvBnReLU):
    def __init__(self, cv, bn, observer_w_name: str, quantizer_w_name: str, observer_a_name: str, quantizer_a_name: str, w_symmetric: bool = True, a_symmetric: bool = True, is_fuse_bn=True):
        super().__init__(cv, bn, None, observer_w_name, quantizer_w_name, observer_a_name, quantizer_a_name, w_symmetric, a_symmetric, is_fuse_bn)
...
class ConvReLU(FakeQuantize):
    def __init__(self,
        ...
        super(ConvReLU, self).__init__(observer_w_name, quantizer_w_name,\
             observer_a_name, quantizer_a_name, w_symmetric, a_symmetric)
...
class Conv(FakeQuantize):
    def __init__(self,
        ...
        super(Conv, self).__init__(observer_w_name, quantizer_w_name,\
             observer_a_name, quantizer_a_name, w_symmetric, a_symmetric)
...
class LinearBnReLU(FakeQuantize):
    def __init__(self, 
        ...
        super().__init__(observer_w_name, quantizer_w_name, observer_a_name, quantizer_a_name, w_symmetric, a_symmetric)
...
class LinearBn(LinearBnReLU):
    def __init__(self, 
                ...
                a_symmetric: bool = True, 
                is_fuse_bn: bool = True):
        super().__init__(linear, bn, None, observer_w_name, quantizer_w_name, observer_a_name, quantizer_a_name, w_symmetric, a_symmetric, is_fuse_bn)
...
class LinearReLU(FakeQuantize):
    def __init__(self,
        ...
        super(LinearReLU, self).__init__(observer_w_name, quantizer_w_name,\
             observer_a_name, quantizer_a_name, w_symmetric, a_symmetric)
        self.linear_fuse = nn.Linear(
            in_features=linear.in_features,
            out_features=linear.out_features,
...
class Linear(FakeQuantize):
    def __init__(self,
        ...
        super(Linear, self).__init__(observer_w_name, quantizer_w_name,\
             observer_a_name, quantizer_a_name, w_symmetric, a_symmetric)
        self.linear_fuse = nn.Linear(
            in_features=linear.in_features,
            out_features=linear.out_features,
