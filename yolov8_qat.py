...
def train(args, params):
    ...
    calibrate_qat_model(qat_model, calib_loader, data_calib, "cpu")
    ...
    with open(os.path.join(args.result_path, 'weights_qat/step_qat.csv'), 'w') as f:
        ...
        for epoch in range(args.epochs):
            ...
            for i, (samples, targets) in p_bar:
                ...
                # print(loss_box, loss_cls)
                # print(qat_model.net.p1[0].conv.weight_quantizer.scale.grad, qat_model.net.p1[0].conv.activation_quantizer.scale.grad
                #       )
